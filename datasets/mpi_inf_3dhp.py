"""PyTorch Dataset for MPI-INF-3DHP (processed NPZ)."""
...
class MPIInf3DHP(Dataset):
    def __init__(self, root: str | Path, split: str = "train", window: int = 27, stride: int = 1):
        self.root = Path(root)
